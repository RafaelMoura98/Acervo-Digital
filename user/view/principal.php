<?php require_once $_SERVER['DOCUMENT_ROOT'].'/Acervo-Digital/config/configuracao.php'; ?>
<div id="main">
    <div id="info_PI">
...
<script>
    const URL_CONTROLLER_PROJETOS = "<?php echo URL_USER_CONTROLLER_PROJETOS; ?>";
    const URL_CONTROLLER_ARQUIVOS = "<?php echo URL_USER_CONTROLLER_ARQUIVOS; ?>";
</script>
